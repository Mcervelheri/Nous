    ...
    <div className="px-2">
      ...
      <div className="lg:hidden mx-8">
        ...
        >
          ...
          <div className="swiper-button-prev absolute left-8 bg-white/70 w-10 h-10 flex items-center justify-center rounded-full text-[#5e4031] transition-all duration-300 hover:bg-[#5e4031] hover:text-white"></div>
