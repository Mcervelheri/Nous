      ...
      <div className="bg-[#bb947e] shadow-gray-600 shadow-md rounded py-5 transition-transform duration-300 hover:scale-105">
        {type === "Informations" && (
          <div className="relative">
            <div className="absolute -top-10  left-1/2 transform -translate-x-1/2 -translate-y-5 bg-[#fff] w-16 h-16 rounded-full flex items-center justify-center shadow-gray-600 shadow-md  transition-transform duration-300 hover:scale-105">
