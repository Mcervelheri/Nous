import "react";
import logoGrande from "/src/assets/logos/logo-nous-grande.png";

const Home = () => {
  return (
    <div id="inicio" className="relative h-screen">
      <div className="inicio fixed inset-0 flex items-center bg-[#bb947e] justify-center z-1 pointer-events-none">
