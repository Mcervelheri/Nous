        ...
        <div className="flex justify-center px-2">
          <div className="flex flex-col px-2">
            <div className="flex flex-row items-center py-2">
              ...
              <p className="text-[#bb947e] whitespace-pre-line">{text}</p>
            </div>
            <div className="flex flex-row items-center py-2">
              <div className="p-1">
                {icon && <img src={icon} alt="Ícone" className="w-4 h-4" />}
              ...
              {text2 && (
                <p className="text-[#bb947e] whitespace-pre-line">{text2}</p>
              )}
            </div>
            <div className="flex flex-row items-center py-2">
              <div className="p-1">
              ...
              {text3 && (
                <p className="text-[#bb947e] whitespace-pre-line">{text3}</p>
              )}
            </div>
          </div>
        </div>
